...
const { Permissions } = require(__dirname+'/../permission/permissions.js')
	, actions = [
		{name:'approve', global:true, auth:Permissions.MANAGE_GLOBAL_GENERAL, passwords:false, build:true},
		{name:'unlink_file', global:true, passwords:true, build:true},
		{name:'delete_file', global:true, auth:Permissions.MANAGE_BOARD_GENERAL, passwords:false, build:true},
		...
		{name:'sticky', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		...
		{name:'move', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'delete_ip_board', global:true, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'delete_ip_thread', global:true, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'delete_ip_global', global:true, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		...
		{name:'untrust', global:false, auth:Permissions.MANAGE_BOARD_GENERAL, passwords:false, build:false},
	];
