...
module.exports = {
	...
	paramConverter: paramConverter({
		...
		numberFields: ['inactive_account_action', 'abandoned_board_action', 'auth_level', 'captcha_options_text_wave', 'captcha_options_text_paint', 'captcha_options_text_noise',
			...
			'board_defaults_thread_limit', 'board_defaults_reply_limit', 'board_defaults_bump_limit', 'board_defaults_emoji_limit', 'board_defaults_max_files', 'board_defaults_min_thread_message_length',
	...
	controller: async (req, res, next) => {
		...
		const errors = await checkSchema([
			...
			{ result: numberBody(req.body.global_limits_emoji_limit_min), expected: true, error: __('Global emoji limit minimum must be a number') },
			{ result: numberBody(req.body.global_limits_emoji_limit_max), expected: true, error: __('Global emoji limit minimum must be a number') },
			{ result: minmaxBody(req.body.global_limits_emoji_limit_min, req.body.global_limits_emoji_limit_max), expected: true, error: __('Global emoji limit min must be less than max') },
			...
			{ result: numberBody(req.body.global_limits_emoji_files_size_max), expected: true, error: __('Emoji files size must be a number') },
			{ result: numberBody(req.body.global_limits_emoji_files_max), expected: true, error: __('Emoji files max must be a number') },
			{ result: numberBody(req.body.global_limits_emoji_files_total), expected: true, error: __('Emoji files total must be a number') },
			...
			{ result: numberBodyVariable(req.body.board_defaults_emoji_limit, globalLimits.emojiLimit.min, req.body.global_limits_emoji_limit_min, globalLimits.emojiLimit.max, req.body.global_limits_emoji_limit_max), expected: true, error: __('Board defaults emoji limit must be within global limits') },
