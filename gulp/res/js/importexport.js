...
window.addEventListener('settingsReady', () => {
	...
	const settingNames = ['volume','loop','imageloadingbars','imagehover','live','scroll','localtime','relative','embedsenabled','24hour','notifications','hiddenimages', 'threadwatcher','autowatch','boardlinkswap'
